    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; color: #111;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
          <tr><td style="padding: 8px 0; color: #888; border-bottom: 1px solid #f0f0f0; width: 120px;">Name</td><td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">${name}</td></tr>
          <tr><td style="padding: 8px 0; color: #888; border-bottom: 1px solid #f0f0f0;">Date</td><td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;"><strong>${date}</strong></td></tr>
          <tr><td style="padding: 8px 0; color: #888; border-bottom: 1px solid #f0f0f0;">Time</td><td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;"><strong>${time}</strong></td></tr>
          <tr><td style="padding: 8px 0; color: #888; border-bottom: 1px solid #f0f0f0;">Service</td><td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">${service}</td></tr>
          <tr><td style="padding: 8px 0; color: #888; border-bottom: 1px solid #f0f0f0;">Vehicle</td><td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">${vehicle}</td></tr>
